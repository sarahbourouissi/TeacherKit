...
class DraggableGridExampleAdapter
    ...
    public DraggableGridExampleAdapter(List<Classe> dataProvider) {
        mProvider = dataProvider;
        mDataProvider = new DragbleList(dataProvider);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        // set text
        holder.mTextView.setText(item.getMatiere());
